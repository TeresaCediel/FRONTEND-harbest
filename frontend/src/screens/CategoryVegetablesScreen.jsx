...
export default function CategoryVegetablesScreen({ navigation }) {
  return (
    <ScreenContainer>
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.heroCard}>
            <View style={styles.heroContent}>
              ...
              <Text style={styles.heroSubtitle}>
                Productos saludables y de cultivo responsable, pensados para tu día a día.
              </Text>

              <View style={styles.heroInfoRow}>
                <View style={styles.heroInfoPill}>
                  <Ionicons name="leaf" size={14} color={colors.primary} />
                  <Text style={styles.heroInfoText}>8 productos</Text>
                </View>
            ...
            <Image
              source={require('../../assets/images/comida/verduras.webp')}
          ...
          <FruitProductCard
            ...
            price="2,80€/kg"
            badge="Temporada"
            image={require('../../assets/images/comida/esparragos.png')}
          />
          ...
          <FruitProductCard
            ...
            price="3,00€/kg"
            badge="Premium"
            image={require('../../assets/images/comida/alcachofas.jpg')}
          />
          </View>
        </ScrollView>
